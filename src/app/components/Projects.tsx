...
const Projects = () => {
  return (
    <section id="projects" className=" py-10 md:py-10 scroll-mt-22">
      <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10">
          {/* Case Study 2: Astu Social */}
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden hover:scale-105 transition-transform"
